...
mesh.source = ff.base.optode(np.array([5,30,57]))
mesh.meas = ff.base.optode(np.array([55,30,57]))


# US freq and pressure

fa = 5e6  # frequency of US (Hz)
P0 = 1e5  # US pressue(pascal) , this value is converted into N/mm2 before assigning the pressure value to nodes